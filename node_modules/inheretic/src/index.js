...
function inherit(parent, child, writer = fs.writeFileSync){
    if(!child._generated){
        ...
        const fileName = path.dirname(_filename) + "/package.json";
...
module.exports(process.argv[2], process.argv[4] ? debugWriter : fs.writeFileSync, process.argv[3]);

// const program = require('commander');
// program
//   .version('0.0.1')
//   .command('<dir>', 'create/update child project package.json files using maven like inheritance', {isDefault: true})
//   .option('-t, --template-name [template-name]', 
//           'Filenaming convention for package.json templates [package.json].')
//   .action((dir, cmd) => {
