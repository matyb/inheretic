...
function chainInherit(families, [key, ...tail] = Object.keys(families)){
    ...
    if(family){
        ...
        if(parentFamily){
            ...
            module.exports.chainInherit(families, tail);
            family.parent = parentFamily.child;
            tail.splice(0, 1);
        }
        module.exports.inherit(family.parent, family.child);
        module.exports.chainInherit(families, tail);
    }
}
...
function inheretic(parent, packageName = 'package.json'){
    ...
    module.exports.chainInherit(families);
}
